...
export const databasesTools: ToolDef[] = [
  ...
  defineTool({ name: "delete_database_backup_repo", title: "Delete database backup repo", description: "Delete a backup repository. With mode=destroy, stored backups are deleted too. Cannot be undone.", group: "databases", sdkRef: "databaseInfrastructure.deleteBackupRepoDatabaseInfrastructure", readOnly: false, destructive: true, idempotent: true, inputSchema: deleteDatabaseBackupRepoShape, run: (c, a) => c.databaseInfrastructure.deleteBackupRepoDatabaseInfrastructure(a) }),
